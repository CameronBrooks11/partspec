...
> **Status: pre-alpha; v0.5.0 is on PyPI.** It runs end to end — `check`, `measure` and
> `render` across all three engines, `diff` on the reports they produce — and is dogfooded on real
