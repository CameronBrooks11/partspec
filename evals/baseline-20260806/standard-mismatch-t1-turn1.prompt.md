...
```
$ partspec check spec.py:baseplate
ok   builds
  FAIL envelope
  ok   watertight
  ok   solid_count
...
FAIL: 4 pass, 1 fail
  /tmp/partspec-eval-standard-mismatch-z4sn8qsc/standard-mismatch/outputs/spec-baseplate/report.json
exit code: 1
```

The full machine-readable report is at `outputs/spec-eval-standard-mismatch/report.json`. You may read it.
